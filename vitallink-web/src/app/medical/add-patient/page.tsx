  ...
  return (
    <div className="bg-gray-50 flex-grow py-12">
      <div className="container mx-auto px-4 max-w-2xl">
        <h1 className="text-3xl font-bold">Add New Patient (Recipient)</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6 rounded-lg bg-white p-8 shadow-md">
          <div>
            ...
            <input type="text" id="fullName" value={fullName} onChange={(e) => setFullName(e.target.value)} required
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-theme-500 focus:ring-theme-500 sm:text-sm"
            />
          </div>
          <div>
          ...
          <div>
            ...
            />
            <div className="text-center font-semibold text-theme-600">{medicalUrgency}</div>
          </div>
          <div>
            <button type="submit"
              className="w-full rounded-md bg-theme-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-theme-600 focus:outline-none focus:ring-2 focus:ring-theme-500 focus:ring-offset-2"
            >
              Add Patient
            </button>
          </div>
